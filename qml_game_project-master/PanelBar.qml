    ...
    Rectangle {
        ...
        RowLayout {
            ...
            RowLayout {
                spacing: space
                Image {
                    source: arr_1_visible ? "img/warrior_s1.jpg" : "img/archer_s1.jpg"
                ...
                Image {
                    source: arr_1_visible ? "img/warrior_s2.jpg" : "img/archer_s2.jpg"
                    Text {
                        id: text_2
                        text: "2"
                        color: "white"
                ...
                Image {
                    source: arr_1_visible ? "img/warrior_s3.jpg" : "img/archer_s3.jpg"
                    Text {
                        id: text_3
                        text: "3"
                        color: "white"
                ...
                Image {
                    source: arr_1_visible ? "img/warrior_b4.jpg" : "img/archer_b4.jpg"
                    Text {
                        id: text_4
                        text: "4"
                        color: "white"
                ...
                Image {
                    source: arr_1_visible ? "img/warrior_d5.jpg" : "img/archer_d5.jpg"
                    Text {
                        id: text_5
                        text: "5"
                        color: "white"
