...
Item {
    ...
    SpriteSequence {
        ...
        Sprite {
            ...
            source: "img/ss_warrior.png" //ссылка на изображение
        ...
        Sprite {
            id: hero1_s4
            name: "moveback"
            source: "img/ss_warrior_reverse.png" //ссылка на изображение
            frameCount: 4 //hero_frame количество кадров в анимации
            frameDuration: 200
            frameWidth: 303 //параметры кадра
            frameHeight: 303
    ...
    SpriteSequence {
        ...
        Sprite {
            id: hero1c_b45d
            name: "dismiss"
            source: "img/ss_effects.png" //ссылка на изображение
    ...
    SpriteSequence {
        ...
        Sprite {
            id: hero2_s1
            name: "stay" //имя спрайта
            source: "img/ss_archer_reverse.png" //ссылка на изображение
            frameCount: 6 //hero_frame количество кадров в анимации
            frameDuration: 400
            frameWidth: 303 //параметры кадра
            frameHeight: 303
    ...
    SpriteSequence {
        ...
        Sprite {
            ...
            frameWidth: 303 //параметры кадра
            frameHeight: 303
            frameX: 1212 //X координата в файле изображения
            frameY: 1818 //Y
         }
